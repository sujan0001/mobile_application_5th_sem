...
//             ),
//             const SizedBox(height: 16),
//             ...products.map((product) => BlocProvider(
...
class _ProductsList extends StatelessWidget {
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        Expanded(
                          flex: 2,
                          child: _buildViewDetailsButton(context, product),
                        ),
                        const SizedBox(width: 8),
                        // Request Transfer Button
                        Expanded(
                          flex: 3,
                          child: _buildRequestTransferButton(context, product),
                        ),
                      ],
                    ),
                  ],
  ...
  Widget _buildViewDetailsButton(BuildContext context, ProductEntity product) {
    return SizedBox(
      height: 38,
    ...
    Navigator.of(context).push(
      MaterialPageRoute(
        builder: (context) => ProductDetailView(
          ...
          isOwned: false, // Set to false since this is from the general products list
        ),
      ),
    );
  }
